SELECT
    ...
    --RAW:"items" AS items,
    --RAW:"collected_traffic_source"."manual_campaign_id"::string AS collected_traffic_source_manual_campaign_id,
    RAW:"collected_traffic_source"."manual_campaign_name"::string AS collected_traffic_source_manual_campaign_name,
    RAW:"collected_traffic_source"."manual_source"::string AS collected_traffic_source_manual_source,
    RAW:"collected_traffic_source"."manual_medium"::string AS collected_traffic_source_manual_medium,
    RAW:"collected_traffic_source"."manual_term"::string AS collected_traffic_source_manual_term,
    RAW:"collected_traffic_source"."manual_content"::string AS collected_traffic_source_manual_content,
